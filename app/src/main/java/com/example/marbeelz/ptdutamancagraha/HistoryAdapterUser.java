...
public class HistoryAdapterUser extends RecyclerView.Adapter<HistoryAdapterUser.RecycleViewHolder> {
    private Context mContext;
    private List<Booking> mBooking;
    private OnItemClickListener mListener;
    public HistoryAdapterUser(Context context, List<Booking> bookings){
        mContext = context;
        mBooking = bookings;
    }
    @NonNull
